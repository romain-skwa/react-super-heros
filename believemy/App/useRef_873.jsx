            ...
            <div style={{
              ...
              <div>
                ...
                <input
                  ...
                  name="photo"
                  id="photo"
                  ref={portraitNormal} // useRef à la place de "Value" et "onChange"
                  style={{
                    padding: 5,
                    fontSize: 14,
                    display: "block",
                ...
                <div>
                  ...
                  name="nom" 
                  id="nom" 
                  ref={nom} // useRef à la place de "Value" et "onChange"
                  size="40"
                ...
                <div>
                  ...
                  name="description" 
                  id="description" 
                  ref={description} // useRef à la place de "Value" et "onChange"
